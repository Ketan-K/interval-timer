...
> A sleek, distraction-free interval timer with round counter and rest intervals. Minimalist, offline-ready, and built with zero external dependencies.
...
- ⚡ **Precision 60fps Timing Engine:**
  - Eliminates timer background drift by utilizing `requestAnimationFrame` and high-resolution timestamp deltas.
